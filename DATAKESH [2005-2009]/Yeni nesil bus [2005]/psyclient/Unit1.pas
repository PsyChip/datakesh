...
if xx=5 then Memo1.Lines.Add('Çözünürlük : '+parcala(cevap,xx));
if xx=6 then Memo1.Lines.Add('Orjinal ismi : '+parcala(cevap,xx));
if xx=7 then Memo1.Lines.Add('Kayýtlý Kullanýcý : '+parcala(cevap,xx));
if xx=8 then Memo1.Lines.Add('Kayitli firma : '+parcala(cevap,xx));
if xx=9 then Memo1.Lines.Add('Calisma Süresi : '+hesapla(strtoint(parcala(cevap,xx))));
if xx=10 then Memo1.Lines.Add('Bo$ta Kalan süre(idle) : '+hesapla(strtoint(parcala(cevap,xx))));
end;
Memo1.Lines.Add('*********************************************');
GOTO SON
end;
